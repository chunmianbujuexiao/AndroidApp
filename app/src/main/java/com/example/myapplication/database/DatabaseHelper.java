...
//                "clocktime TEXT,starttime TEXT,endtime TEXT,edit_time TimeStamp NOT NULL DEFAULT (datetime('now','localtime'))"+")";
        String sql2 = "CREATE TABLE IF NOT EXISTS task(_id INTEGER PRIMARY KEY AUTOINCREMENT,title TEXT,content TEXT," +
                "clocktime TEXT,starttime TEXT,endtime TEXT,edittime Text"+")";
